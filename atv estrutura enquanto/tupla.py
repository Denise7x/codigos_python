...
print(objetos[1]) #Irei exibir o item na posição 1, ou seja, segunda posição, ma vez que toda coleção começa na posição zero
...
for item in range(0,3):
    ...
    # Exibindo todos os itens da tupla sem função range 
    print("-"*50)
